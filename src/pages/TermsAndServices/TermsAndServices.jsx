          ...
          <div className="terms-main-section section">
            ...
            <div className="terms-main-disclosure disclosure">
              ...
              >
                ...
                <ul className="content-list">
                  <li className="content-list__item">
                    If you place your order between the opening time and up to 1
                    hour before the closing time of your selected store(s), it
                    will be ready for you to collect within 1 hour on the same
                    day.
                  </li>
                  <li className="content-list__item">
                    If you place your order later than 1 hour before the closing
                    time and before the next day’s opening time of your selected
                    store(s), it will be ready for you to collect within 1 hour
            ...
            <div className="terms-main-disclosure disclosure">
              ...
              >
                <ul className="content-list">
                  ...
                  <li className="content-list__item">
                    The process to pre-order looks extremely similar to placing
                    a regular order. Additionally, you may receive email updates
                    if the release date changes — and if this happens,
                  ...
                  <li className="content-list__item">
                    The checkout process looks the same as a regular order, and
            ...
            <div className="terms-main-disclosure disclosure">
              ...
              >
                ...
                <ul className="content-list">
                  ...
                  <li className="content-list__item">
                    Returned items which are not in new or unused condition may
                    not be fully credited to your account unless they are
          ...
          <div className="terms-main-section section">
            ...
            <div className="terms-main-disclosure disclosure">
              ...
              >
                ...
                <h4 className="disclosure-header__header">In-store:</h4>
                <ul className="content-list">
                  <li className="content-list__item">
                ...
                <h4 className="disclosure-header__header">Phone:</h4>
                <ul className="content-list">
                  <li className="content-list__item">
                    All major credit and debit cards
                  </li>
          ...
          <div className="terms-main-section section">
            ...
            <div className="terms-main-disclosure disclosure">
              ...
              >
                ...
                <h4 className="disclosure-header__header">Personal Data</h4>
                <p className="content__text">
                ...
                <ul className="content-list">
                  <li className="content-list__item">Email address</li>
                  <li className="content-list__item">
                    First name and last name
                  </li>
                  <li className="content-list__item">Phone number</li>
                  <li className="content-list__item">
                    Address, State, Province, ZIP/Postal code, City
                  </li>
                  <li className="content-list__item">Usage Data</li>
                </ul>
                <h4 className="disclosure-header__header">Usage Data</h4>
                <p className="content__text">
